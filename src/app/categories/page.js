...
export async function generateMetadata({ searchParams }) {
  ...
  const baseDescription =
    "Explore our curated collection of premium skincare, fragrances, and beauty products. Natural, sustainable, and effective solutions for your beauty routine.";
...
function addCategoriesJsonLd(categories) {
  const structuredData = {
    ...
    description:
      "Comprehensive collection of premium beauty, skincare, and fragrance categories",
...
export default async function Categories({ searchParams }) {
  ...
  try {
    ...
    const [categoriesRes] = await Promise.allSettled([FetchData(apiUrl)]);
      ...
      <>
        ...
        <div className="min-h-screen bg-gray-50 pt-10">
          ...
          <div className="sr-only" aria-hidden="true">
            ...
            <p>
              Discover our comprehensive range of premium beauty products
              including skincare essentials, luxurious fragrances, body care,
              and sustainable beauty solutions. Each category features carefully
              crafted products with natural ingredients for your wellness
              routine.
            </p>
