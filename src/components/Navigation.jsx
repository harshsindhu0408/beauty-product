        ...
        <>
          ...
          <div className="p-2 border-t border-gray-100">
            <div
              ...
              className="group flex items-center justify-center w-full text-center px-4 py-3 text-sm font-semibold text-white bg-black rounded-lg hover:bg-gray-800 transition-all cursor-pointer shadow-lg hover:shadow-xl transform"
            >
        ...
        <div className="flex items-center justify-between h-20 gap-8">
          ...
          >
            <form onSubmit={handleSearchSubmit} className="w-full">
              ...
              >
                ...
                {!isSearchFocused && !searchQuery && (
                  <div className="absolute left-12 top-1/2 -translate-y-1/2 text-gray-400 text-sm pointer-events-none font-medium tracking-wide">
                    Search for products...
                  </div>
                )}
            ...
            {isSearchFocused && searchQuery.trim().length > 0 && (
              <div className="absolute top-full left-0 right-0 mt-4 rounded-2xl border border-gray-100 bg-white shadow-2xl z-50 overflow-hidden ring-1 ring-black/5">
          ...
          <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
            {navLinks.map((link) => {
              ...
              return (
                ...
                >
                  <div className="relative p-2 rounded-full group-hover:bg-gray-50 transition-colors">
                  ...
                  <span className="text-[10px] font-medium uppercase tracking-wider text-gray-500 group-hover:text-black transition-colors">
                    {link.name}
                  </span>
                </div>
              );
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden p-2 text-gray-900 transition-colors hover:bg-gray-50 rounded-full"
