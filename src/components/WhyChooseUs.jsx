...
const WhyChooseUs = () => {
  ...
  const features = [
    {
      ...
      title: "Best Price",
      description:
        "We offer exclusive deals without compromising on quality or results.",
      bgColor: "bg-purple-200",
      cardColor: "bg-purple-100",
      iconColor: "text-purple-600",
      image:
        "https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1065&q=80",
    },
    {
      id: 2,
      icon: Award,
      title: "Best Quality",
      description:
        "Only the finest skincare, made with high-quality natural ingredients.",
      bgColor: "bg-gray-600",
    ...
    },
    {
      ...
      title: "Guaranteed",
      description:
        "Products are 100% original, quality-checked, free return guarantee.",
      bgColor: "bg-gray-800",
      cardColor: "bg-gray-700",
      iconColor: "text-white",
      textColor: "text-white",
    ...
    },
    {
      ...
      title: "Eco - Friendly",
      description:
        "Our products are eco-conscious, crafted with sustainable ingredients.",
      bgColor: "bg-gray-100",
      cardColor: "bg-white",
    ...
    },
    {
      ...
      title: "Premium Care",
      description:
        "Luxury skincare experience with professional-grade formulations.",
      bgColor: "bg-rose-200",
      cardColor: "bg-rose-100",
      iconColor: "text-rose-600",
      image:
        "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1065&q=80",
    },
    {
      id: 6,
      icon: DollarSign,
      ...
      description:
        "Maximum benefits and results at competitive prices for everyone.",
      bgColor: "bg-blue-200",
      cardColor: "bg-blue-100",
      iconColor: "text-blue-600",
      image:
        "https://images.unsplash.com/photo-1596462502278-27bfdc403348?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1980&q=80",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="absolute w-[600px] h-[400px] bg-pink-100 rounded-full mix-blend-multiply filter -translate-1/2 blur-3xl top-1/2 left-1/2"></div>
        ...
        <div className="hidden xl:block relative min-h-[800px] flex items-center justify-center">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center z-20">
            <div className="text-center max-w-2xl mx-auto">
              ...
              >
                Various reasons why you should buy our products to increase your
            ...
            return (
              <div
                ...
                className={`absolute rounded-3xl p-6 ${
                  feature.cardColor
                } shadow-lg cursor-pointer text-center overflow-hidden w-[250px] transition-all duration-1000 ease-out hover:scale-105 hover:-translate-y-2 ${
                  isVisible
                ...
                style={{
                  ...
                  transform: isVisible
                    ...
                    : "translate(0, 32px) scale(0.95)",
                  transitionDelay: `${200 + index * 200}ms`,
                  transition:
                    "all 0.3s ease-out, opacity 1s ease-out, transform 1s ease-out",
                }}
              >
                {/* Background Image */}
                {feature.image && (
                ...
                {/* Content */}
                <div
                  className={`relative text-center flex items-center flex-col z-10 ${
                    feature.image
                      ? "text-white"
                ...
                >
                  {/* Icon */}
                  <div
                    className={`w-20 h-20 rounded-full ${feature.bgColor} flex items-center justify-center mb-4 transition-transform duration-300 hover:scale-110`}
                  >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
            {features.map((feature, index) => (
              <div
                ...
                className={`relative rounded-2xl sm:rounded-3xl p-4 sm:p-6 ${
                  feature.cardColor
                } shadow-lg cursor-pointer overflow-hidden transition-all duration-1000 ease-out hover:scale-105 hover:-translate-y-1 ${
                  isVisible
                    ? "opacity-100 translate-y-0"
              ...
              >
                ...
                >
                  {/* Icon */}
                  <div
                    className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full ${feature.bgColor} flex items-center justify-center mb-3 sm:mb-4 transition-transform duration-300 hover:scale-110`}
                  >
                    <feature.icon
